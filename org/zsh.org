...
I am using =ZSH=[cite:@noauthor_zsh_nodate] as my default shell. It is POSIX compliant
...
The following configuration are from GRML's ZSH config[cite:@noauthor_grml.org_nodate]:
