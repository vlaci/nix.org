...
We need to tell =stylix=, that we want to use a 256 color theme,
otherwise there can be accessibility issues with color mapping,
e.g. comment color will be unreadable dark in editors.
