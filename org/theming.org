  ...
  security.sudo.extraRules = [
    {
      groups = [ "wheel" ];
      commands = [
        { command = "/nix/var/nix/profiles/system/bin/switch-to-configuration test"; options = [ "SETENV" "NOPASSWD" ]; }
        { command = "/nix/var/nix/profiles/system/specialisation/day/bin/switch-to-configuration test"; options = [ "SETENV" "NOPASSWD" ]; }
      ];
    }
  ];
}
